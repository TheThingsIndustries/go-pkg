...
var file_tti_gateway_controller_northbound_v1_profile_services_proto_rawDesc = string([]byte{
...
var (
	...
	file_tti_gateway_controller_northbound_v1_profile_services_proto_rawDescData []byte
)
...
func file_tti_gateway_controller_northbound_v1_profile_services_proto_rawDescGZIP() []byte {
	file_tti_gateway_controller_northbound_v1_profile_services_proto_rawDescOnce.Do(func() {
		file_tti_gateway_controller_northbound_v1_profile_services_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tti_gateway_controller_northbound_v1_profile_services_proto_rawDesc), len(file_tti_gateway_controller_northbound_v1_profile_services_proto_rawDesc)))
	})
...
var file_tti_gateway_controller_northbound_v1_profile_services_proto_goTypes = []any{
...
func file_tti_gateway_controller_northbound_v1_profile_services_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tti_gateway_controller_northbound_v1_profile_services_proto_rawDesc), len(file_tti_gateway_controller_northbound_v1_profile_services_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   52,
			NumExtensions: 0,
			NumServices:   4,
