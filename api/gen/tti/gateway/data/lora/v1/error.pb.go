...
var file_tti_gateway_data_lora_v1_error_proto_rawDesc = string([]byte{
...
var (
	...
	file_tti_gateway_data_lora_v1_error_proto_rawDescData []byte
)
...
func file_tti_gateway_data_lora_v1_error_proto_rawDescGZIP() []byte {
	file_tti_gateway_data_lora_v1_error_proto_rawDescOnce.Do(func() {
		file_tti_gateway_data_lora_v1_error_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tti_gateway_data_lora_v1_error_proto_rawDesc), len(file_tti_gateway_data_lora_v1_error_proto_rawDesc)))
	})
...
var file_tti_gateway_data_lora_v1_error_proto_goTypes = []any{
...
func file_tti_gateway_data_lora_v1_error_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tti_gateway_data_lora_v1_error_proto_rawDesc), len(file_tti_gateway_data_lora_v1_error_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
